        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <form action="<?= site_url('customers/save') ?>" method="POST" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="form-group">
                                <label>Name Customer *</label>
                                <input type="text" class="form-control" name="name_customer" placeholder="Name Customer is required" required>
                            </div>
                            <div class="form-group">
                                <label>Gender *</label>
