        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <form action="<?= site_url('units/save') ?>" method="POST" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="form-group">
                                <label>Name Unit *</label>
                                <input type="text" class="form-control" name="name_unit" placeholder="Name Unit is required" required>
                            </div>
                        </div>
                        <!-- /.box-body -->
