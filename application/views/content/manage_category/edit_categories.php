    ...
    <div class="box">
        <div class="box-header">
            ...
            <div class="pull-right">
                <a href="<?= site_url('categories') ?>" class="btn btn-warning btn-sm">
                    ...
                    <form action="<?= site_url('categories/update') ?>" method="POST" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name_category" value="<?= $category['name_category'] ?>" placeholder="Name Category is required" required>
                            </div>
                        </div>
                        <!-- /.box-body -->
