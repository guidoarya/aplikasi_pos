<body class="hold-transition skin-blue sidebar-mini <?= $title == 'Sale Product' ? 'sidebar-collapse' : null ?>">
  <!-- Site wrapper -->
  <div class="wrapper">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview <?= ($icon == 'archive') ? 'active' : '' ?>">
            ...
            <ul class="treeview-menu">
              ...
              <li <?= ($title == 'Voucher Product') ? 'class="active"' : 'class=""' ?>><a href="<?= site_url('manage_voucher') ?>"><i class="fa fa-circle-o"></i> Voucher</a></li>
            </ul>
          </li>
          <li class="treeview <?= ($icon == 'shopping-cart') ? 'active' : '' ?>">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li <?= ($title == 'Sale Product') ? 'class="active"' : 'class=""' ?>><a href="<?= site_url('sale') ?>"><i class="fa fa-circle-o"></i> Sale</a></li>
              <li <?= ($title == 'Stock in') ? 'class="active"' : 'class=""' ?>><a href="<?= site_url('stock-in') ?>"><i class="fa fa-circle-o"></i> Stock in / Purchases</a></li>
              <li <?= ($title == 'Stock out') ? 'class="active"' : 'class=""' ?>><a href="<?= site_url('stock-out') ?>"><i class="fa fa-circle-o"></i> Stock Out</a></li>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="<?= site_url('reports/sale') ?>"><i class="fa fa-circle-o"></i> Sale</a></li>
